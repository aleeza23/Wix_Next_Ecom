...
const Footer = () => {
    return (
        <section className="pt-16 pb-7 mt-10 bg-gray-900">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col sm:flex-row items-center justify-between  border-b border-gray-500 gap-5">
                    <Image src={'/logo-modified.png'} width={130} height={10} className='-mb-8 md:-ms-8 ms-0' />
                    <div className="flex items-center gap-4 mb-10 md:mb-0">
                        <Link href="#"
                            className="p-3 rounded-full bg-white text-gray-700 group transition-all duration-500 hover:bg-blue-600 hover:text-white focus-within:outline-0 focus-within:bg-blue-600 focus-within:text-white">
                        ...
                        <Link href="#"
                            className="p-3 rounded-full bg-white text-gray-900 group transition-all duration-500 hover:bg-blue-600 hover:text-white focus-within:outline-0 focus-within:bg-blue-600 focus-within:text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                <path
                ...
                <div className="py-14 flex flex-col lg:flex-row justify-between gap-8 border-b border-gray-500">
                    <div className="w-full max-lg:mx-auto flex flex-col sm:flex-row max-lg:items-center max-lg:justify-between gap-6 md:gap-12 lg:gap-24">
                        <div className="">
                            <h6 className="text-lg font-medium text-white mb-7 max-lg:text-center">Useful Links</h6>
                            <ul className="flex flex-col max-lg:items-center gap-6">
                                <li><Link href="#"
                                    className="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-blue-600 focus-within:outline-0 focus-within:text-blue-600">Home</Link>
                                </li>
                                <li><Link href="#"
                                    className="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-blue-600 focus-within:outline-0 focus-within:text-blue-600">About</Link>
                                </li>
                                <li><Link href="#"
                                    className="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-blue-600 focus-within:outline-0 focus-within:text-blue-600">Pricing</Link>
                                </li>
                                <li><Link href="#"
                                    className="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-blue-600 focus-within:outline-0 focus-within:text-blue-600">Pro
                                    Version</Link></li>
                            </ul>
                        </div>
                        <div className="">
                            ...
                            <ul className="flex flex-col gap-6 max-lg:items-center">
                                <li><Link href="#"
                                    className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-blue-600 focus-within:outline-0 focus-within:text-blue-600">Figma
                                    UI System</Link></li>
                                <li><Link href="#"
                                    className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-blue-600 focus-within:outline-0 focus-within:text-blue-600">Icons
                                    Assets</Link></li>
                                <li><Link href="#"
                                    className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-blue-600 focus-within:outline-0 focus-within:text-blue-600">Responsive
                                    Blocks</Link></li>
                                <li><Link href="#"
                                    className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-blue-600 focus-within:outline-0 focus-within:text-blue-600">Components
                                    Library</Link></li>
                            </ul>
                        </div>
                        <div className="">
                            ...
                            <ul className="flex flex-col gap-6 max-lg:items-center">
                                <li><Link href="#"
                                    className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-blue-600 focus-within:outline-0 focus-within:text-blue-600">FAQs</Link>
                                </li>
                                <li><Link href="#"
                                    className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-blue-600 focus-within:outline-0 focus-within:text-blue-600">Quick
                                    Start</Link></li>
                                <li><Link href="#"
                                    className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-blue-600 focus-within:outline-0 focus-within:text-blue-600">Documentation</Link>
                                </li>
                                <li><Link href="#"
                                    className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-blue-600 focus-within:outline-0 focus-within:text-blue-600">User
                                    Guide</Link></li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div className="flex flex-col min-[540px]:flex-row items-center justify-between gap-3">
                                    <div className="flex items-start black">
                                        ...
                                        <label htmlFor="checked-checkbox" className="text-sm font-normal cursor-pointer text-gray-400">
                                            I agree with <a href="#" className="text-blue-600">Privacy Policy</a> and <a
                                                href="#" className="text-blue-600">Terms of Condition</a></label>
                                    </div>
                                    <input type="submit" value="Send"
                                        className="text-white text-base font-semibold py-3 px-7 rounded-full cursor-pointer bg-blue-600 transition-all duration-500 hover:bg-white hover:text-gray-900" />
                                </div>
