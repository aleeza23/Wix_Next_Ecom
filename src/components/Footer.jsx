        ...
        <section className="pt-16 pb-7 mt-10 bg-gray-900">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col sm:flex-row items-center justify-between  border-b border-gray-500 gap-5">
                    <Image src={'/logo-modified.webp'} width={130} height={10} className='-mb-8 md:-ms-8 ms-0' />
                    <div className="flex items-center gap-4 mb-10 md:mb-0">
                        <Link href="https://www.facebook.com/share/XwmNLkSsPuPrtD3H/?mibextid=LQQJ4d"
                ...
                <div className="py-14 flex flex-col lg:flex-row lg:justify-between gap-8 border-b border-gray-500">
                    <div className="w-full max-lg:mx-auto flex flex-col sm:flex-row  max-lg:items-center max-lg:justify-between gap-6 md:gap-12 lg:gap-24">
                        <div className=" mt-0 md:mt-10 mx-auto">
                            ...
                            <ul className="flex flex-col max-lg:items-center gap-6">
                                ...
                                <li><Link href="/list"
                                    className="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-blue-600 focus-within:outline-0 focus-within:text-blue-600">Products</Link></li>
                                <li><Link href="/about"
                                ...
                                <li><Link href="/contact"
                                    className="text-base font-normal max-lg:text-center text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-blue-600 focus-within:outline-0 focus-within:text-blue-600">Conatct</Link>
                                </li>

                            </ul>
                        </div>
                        <div className="mt-0 hidden lg:block lg:mt-10">
                            <h6 className="text-lg font-medium text-white mb-7 max-lg:text-center">Contact Information</h6>
                            <ul className="flex flex-col gap-6 max-lg:items-center">
                                <li>
                                    <p className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-blue-600 focus-within:outline-0 focus-within:text-blue-600">
                                        Address: Main Boulevard, E Sector, DHA 2, Islamabad
                                    </p>
                                </li>
                                <li>
                                    <p className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-blue-600 focus-within:outline-0 focus-within:text-blue-600">
                                ...
                                <li>
                                    <p className="text-base font-normal text-gray-400 whitespace-nowrap transition-all duration-300 hover:text-blue-600 focus-within:outline-0 focus-within:text-blue-600">
                                        Email: <a href="mailto:umerbashir70827082@gmail.com" className="hover:text-blue-600 focus-within:text-blue-600">umerbashir70827082@gmail.com</a>
                                    </p>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div className="w-full lg:max-w-xl max-lg:mx-auto">
                        {/* <h6 className="text-lg font-medium text-white mb-7">Our Location</h6> */}
                        <div className="bg-gray-800 rounded-3xl p-5">
                            <div className="relative">
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3318.5189634863065!2d73.1004483152087!3d33.69497378070285!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x38df950a1f1e9d23%3A0xd2df6f8d8a8a3e5!2sMain%20Boulevard%2C%20DHA%20Sector%20E%20DHA%202%2C%20Islamabad%2C%20Islamabad%20Capital%20Territory%2C%20Pakistan!5e0!3m2!1sen!2s!4v1696590518355!5m2!1sen!2s"
                                    width="100%"
                                    height="225"
                                    style={{ border: 0 }}
                                    allowFullScreen=""
