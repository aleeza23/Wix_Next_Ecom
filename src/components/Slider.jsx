...
const Slider = () => {
  ...
  return (
    <div className="relative">
      <div className="relative overflow-hidden w-full h-[20vh] sm:h-[40vh]  md:h-[80vh]">
        {/* Banner Content */}
        <div className="relative w-full h-full flex-shrink-0">
          ...
          />
          <div className="absolute inset-0 flex flex-col me-auto mt-5 sm:mt-10 md:mt-24 ms-5 lg:ms-28 text-gray-900">
            <h1 className="max-w-2xl mb-4 text-xl sm:text-4xl font-extrabold tracking-tight w-[65%] sm:w-[60%] md:w-full leading-none md:text-5xl xl:text-5xl">Explore the iPhone Series</h1>
